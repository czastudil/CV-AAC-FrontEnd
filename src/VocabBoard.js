    ...
    */
    ...
    function determineWordsFromSelectedItem() {
        if(selectedItem === 'blocks') {
            ...
            setContextualWords([
                { word: "boy", partOfSpeech: "noun", symbol: "\\symbols\\boy.png"},
                { word: "play", partOfSpeech: "verb", symbol: "\\symbols\\play.png" },
                { word: "friend", partOfSpeech: "noun", symbol: "\\symbols\\friend.png" },
                { word: "run", partOfSpeech: "verb", symbol: "\\symbols\\run.png" },
                { word: "school", partOfSpeech: "noun", symbol: "\\symbols\\school.png"},
                { word: "funny", partOfSpeech: "descriptor", symbol: "\\symbols\\funny.png" },
                { word: "fast", partOfSpeech: "descriptor", symbol: "\\symbols\\fast.png" }]);
    ...
    function wordToCurrentWordButton(value, index) {
        return (
            <div 
    ...
    function wordToWordButtonBeginner(value, index, array) {
        return (
            ...
            onClick={() => handlePlayBeginner(value.word)}>
                <img className="buttonSymbol" src={value.symbol}/>
                <div className='wordOnly'>{value.word}</div>
            </button>
        )
    }
